...
type ProxySpec struct {
	...
	Frontend *ProxySpec_EndpointSpec `protobuf:"bytes,2,opt,name=frontend" json:"frontend,omitempty"`
	// Backend is the backend addr/port to proxy requests to.
	Backend *ProxySpec_EndpointSpec `protobuf:"bytes,3,opt,name=backend" json:"backend,omitempty"`
}
...
func (m *ProxySpec) GetFrontend() *ProxySpec_EndpointSpec {
	if m != nil {
		return m.Frontend
	}
	return nil
...
func (m *ProxySpec) GetBackend() *ProxySpec_EndpointSpec {
	if m != nil {
		return m.Backend
	}
	return nil
...
type ProxySpec_EndpointSpec struct {
	Addr string `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`
	Port uint32 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`
}

func (m *ProxySpec_EndpointSpec) Reset()                    { *m = ProxySpec_EndpointSpec{} }
func (m *ProxySpec_EndpointSpec) String() string            { return proto.CompactTextString(m) }
func (*ProxySpec_EndpointSpec) ProtoMessage()               {}
func (*ProxySpec_EndpointSpec) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{6, 0} }

func (m *ProxySpec_EndpointSpec) GetAddr() string {
	if m != nil {
		return m.Addr
	}
	return ""
...
func (m *ProxySpec_EndpointSpec) GetPort() uint32 {
	if m != nil {
		return m.Port
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ProxySpec_EndpointSpec)(nil), "ProxySpec.EndpointSpec")
}
...
func (m *ProxySpec_EndpointSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProxySpec_EndpointSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ProxySpec_EndpointSpec) Size() (n int) {
	var l int
	_ = l
	l = len(m.Addr)
	if l > 0 {
...
func (m *ProxySpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Frontend == nil {
				m.Frontend = &ProxySpec_EndpointSpec{}
			}
		...
		case 3:
			...
			if m.Backend == nil {
				m.Backend = &ProxySpec_EndpointSpec{}
			}
...
func (m *ProxySpec_EndpointSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorProxy = []byte{
	...
	,
}
